# Autoimmune Disease Diagnostics Market and Forecast 2025-2033
...
# Autoimmune Disease Diagnostics Market by TestMethod (Antinuclear Antibody Tests, Autoantibody Tests, C-Reactive Protein, Complete Blood Count, Comprehensive Metabolic Panel, Erythrocyte Sedimentation Rate, Urinalysis) and Applications (Grave’s Disease, Hashimoto’s Thyroiditis, Multiple Sclerosis, Rheumatoid Arthritis, Systemic Lupus Erythematosus, Type 1 Diabetes) and Forecast 2025-2033
...
The global autoimmune disease diagnostics market report estimates the market size ($million 2023 to 2033) for market segmentation based on testing methods and their applications (Grave’s disease, Hashimoto’s thyroiditis, multiple sclerosis, rheumatoid arthritis, systemic lupus erythematosus, Type 1 diabetes, etc.) and forecast (CAGR%, 2025 to 2033).
...
**DATA INCLUDED:** Autoimmune Disease Diagnostics Market Size, Autoimmune Disease Diagnostics Market Share, Autoimmune Disease Diagnostics Market Growth Rates, Autoimmune Disease Diagnostics Market Trends, and Autoimmune Disease Diagnostics Market Forecast to 2033
...
Autoimmune Disease Diagnostics Market by TestMethod (Antinuclear Antibody Tests, Autoantibody Tests, C-Reactive Protein, Complete Blood Count, Comprehensive Metabolic Panel, Erythrocyte Sedimentation Rate, Urinalysis) and Applications (Grave’s Disease, Hashimoto's Thyroiditis, Multiple Sclerosis, Rheumatoid Arthritis, Systemic Lupus Erythematosus, Type 1 Diabetes) and Forecast 2025-2033 quantity 
...
1\. **Diagnostic Test**  
1.1. Antinuclear Antibody Tests  
1.2. Autoantibody Tests  
1.3. C-Reactive Protein (CRP)  
1.4. Complete Blood Count (CBC)  
1.5. Comprehensive Metabolic Panel  
1.6. Erythrocyte Sedimentation Rate (ESR)  
1.7. Urinalysis  
1.8. Others
...
2.5. Systemic Lupus Erythematosus  
2.6. Type 1 diabetes  
2.7. Others

3\. **Company Profiles**  
3.1. Abbott Laboratories, Inc.  
3.2. Beckman Coulter, Inc.  
3.3. bioMérieux SA  
3.4. Bio-Rad Laboratories  
3.5. F.Hoffmann-La Roche Ltd.  
3.6. Inova Diagnostics, Inc.  
3.7. Quest Diagnostics  
3.8. Siemens Healthcare  
3.9. SQI Diagnostics, Inc.
